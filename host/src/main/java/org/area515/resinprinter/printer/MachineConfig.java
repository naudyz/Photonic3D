...
public class MachineConfig implements Named {
	...
	public static class UartScreenConfig {
		@XmlElement(name="ComPortSettings")
		private ComPortSettings comPortSettings;
	...
	// FIXME: 2017/9/1 zyd add for uartscreen -s
	@XmlElement(name="UartScreenConfig")
	private UartScreenConfig uartScreenConfig;
	// FIXME: 2017/9/1 zyd add for uartscreen -e
	...
	// FIXME: 2017/9/1 zyd add for uartscreen -s
	@XmlTransient
	public UartScreenConfig getUartScreenConfig() {
		return uartScreenConfig;
	}
	public void setUartScreenConfig(UartScreenConfig uartScreenConfig) {
		this.uartScreenConfig = uartScreenConfig;
	}
	// FIXME: 2017/9/1 zyd add for uartscreen -e
